...
df = pd.read_csv('D:/bank-additional.csv')  # Replace 'bank.csv' with your file path if needed
...
# Assuming the target column is 'outcome' (replace this with the correct column name)
# For this example, let's assume the column to predict is 'y' or something like 'subscribed'
# Update this with your actual column name
df['y'] = df['y'].map({'yes': 1, 'no': 0})  # Replace 'outcome' with the actual column name
